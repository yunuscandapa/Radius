...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/neypV25uGA",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1123437233924481135&scope=bot%20applications.commands&permissions=2146958847",
    },
       {
      link: true,
      name: "Vote",
